 ...
 */
public abstract class XULValueManagerTestBase extends TestCase {
	...
	protected Value parseAndComputeStyle(String xml, String css, String xpath, String prop) throws Exception {
		...
		XULCSSEngine engine = new XULCSSEngine(doc, uri, new ExtendedParserWrapper(new SACParserCSS21()), context);
