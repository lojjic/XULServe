...
/**
 * Manager for CSS2 'border-style' shorthand property
 */
public class BorderStyleShorthandManager extends AbstractValueFactory implements ShorthandManager {
	...
	public void setValues(CSSEngine eng, PropertyHandler ph, LexicalUnit lu, boolean imp) throws DOMException {
		...
		ph.property(CSS2Constants.CSS_BORDER_TOP_STYLE_PROPERTY,    lus[0], imp);
		ph.property(CSS2Constants.CSS_BORDER_RIGHT_STYLE_PROPERTY,  lus[1], imp);
		ph.property(CSS2Constants.CSS_BORDER_BOTTOM_STYLE_PROPERTY, lus[2], imp);
		ph.property(CSS2Constants.CSS_BORDER_LEFT_STYLE_PROPERTY,   lus[3], imp);
	}
}
