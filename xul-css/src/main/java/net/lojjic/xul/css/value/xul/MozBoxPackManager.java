...
/**
 * Manager for XUL '-moz-box-pack' property
 */
public class MozBoxPackManager extends IdentifierManager {
	...
	public Value getDefaultValue() {
		return XULValueConstants.START_VALUE;
	}
	...
	public String getPropertyName() {
		return XULCSSConstants.CSS_MOZ_BOX_PACK_PROPERTY;
	}
