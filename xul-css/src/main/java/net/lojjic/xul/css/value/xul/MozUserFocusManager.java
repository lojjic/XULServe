...
/**
 * Manager for XUL '-moz-user-focus' property
 */
public class MozUserFocusManager extends IdentifierManager {

	protected static final StringMap values = new StringMap();
	static {
		values.put(XULCSSConstants.CSS_IGNORE_VALUE, XULValueConstants.IGNORE_VALUE);
	...
	public String getPropertyName() {
		return XULCSSConstants.CSS_MOZ_USER_FOCUS_PROPERTY;
	}
