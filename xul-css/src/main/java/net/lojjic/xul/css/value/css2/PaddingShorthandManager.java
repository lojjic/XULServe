...
/**
 * Manager for CSS2 'padding' shorthand property
 */
public class PaddingShorthandManager extends AbstractValueFactory implements ShorthandManager {
	...
	public void setValues(CSSEngine eng, PropertyHandler ph, LexicalUnit lu, boolean imp) throws DOMException {
		...
		ph.property(CSS2Constants.CSS_PADDING_TOP_PROPERTY,    lus[0], imp);
		ph.property(CSS2Constants.CSS_PADDING_RIGHT_PROPERTY,  lus[1], imp);
		ph.property(CSS2Constants.CSS_PADDING_BOTTOM_PROPERTY, lus[2], imp);
		ph.property(CSS2Constants.CSS_PADDING_LEFT_PROPERTY,   lus[3], imp);
